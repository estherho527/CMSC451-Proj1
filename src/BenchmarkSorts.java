...
public class BenchmarkSorts {
	...
	public void displayReport(){
		...
		System.out.printf("|%-7s|%27s%26s|%27s%26s|%n", "Size N", "Iterative", "", "Recursive", "");
		...
		for(int i = 0; i < 2; i++) {
			System.out.printf("%15s|%10s|%15s|%10s|", "Average", "Standard", "Average", "Standard");
		}
		System.out.printf("%n|%7s|", "");
		for(int i = 0; i < 2; i++) {
			System.out.printf("%15s|%10s|%15s|%10s|", "Critical", "Deviation", "Execution", "Deviation");
		}
		System.out.printf("%n|%7s|", "");
		for(int i = 0; i < 2; i++) {
			System.out.printf("%15s|%10s|%15s|%10s|", "Operation", "of Count", "Time", "of Time");
		}
		System.out.printf("%n|%7s|", "");
		for(int i = 0; i < 2; i++) {
			System.out.printf("%15s|%10s|%15s|%10s|", "Count", "", "(ns)", "(ns)");
		}
		...
		for(int i = 0; i < dataSizes.length; i++) {
			...
			System.out.printf("%15.2f|%10.2f|%15.2f|%10.2f|%15.2f|%10.4f|%15.6f|%10.6f|", 
